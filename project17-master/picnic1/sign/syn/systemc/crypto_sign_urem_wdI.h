...
// ==============================================================
#ifndef __crypto_sign_urem_wdI__HH__
#define __crypto_sign_urem_wdI__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(crypto_sign_urem_wdI) {
    ...
    SC_CTOR(crypto_sign_urem_wdI):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
