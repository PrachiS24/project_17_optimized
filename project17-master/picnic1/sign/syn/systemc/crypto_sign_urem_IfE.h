...
// ==============================================================
#ifndef __crypto_sign_urem_IfE__HH__
#define __crypto_sign_urem_IfE__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(crypto_sign_urem_IfE) {
    ...
    SC_CTOR(crypto_sign_urem_IfE):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
