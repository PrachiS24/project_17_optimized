...
// ==============================================================
#ifndef __crypto_sign_mul_mbdk__HH__
#define __crypto_sign_mul_mbdk__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(crypto_sign_mul_mbdk) {
    ...
    SC_CTOR(crypto_sign_mul_mbdk):  ACMP_smul_su_U ("ACMP_smul_su_U") {
