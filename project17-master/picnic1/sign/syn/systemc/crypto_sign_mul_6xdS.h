...
// ==============================================================
#ifndef __crypto_sign_mul_6xdS__HH__
#define __crypto_sign_mul_6xdS__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(crypto_sign_mul_6xdS) {
    ...
    SC_CTOR(crypto_sign_mul_6xdS):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
