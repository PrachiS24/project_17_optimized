set moduleName fromBytesToWords
set isTopModule 0
...
set C_modelName {fromBytesToWords}
set C_modelType { void 0 }
set C_modelArgList {
	{ stateAsWords int 64 regular {array 25 { 2 3 } 1 1 }  }
	{ state int 8 regular {array 200 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "stateAsWords", "interface" : "memory", "bitwidth" : 64, "direction" : "READWRITE"} , 
...
set portList { 
	...
	{ stateAsWords_address0 sc_out sc_lv 5 signal 0 } 
	{ stateAsWords_ce0 sc_out sc_logic 1 signal 0 } 
	{ stateAsWords_we0 sc_out sc_logic 1 signal 0 } 
	{ stateAsWords_d0 sc_out sc_lv 64 signal 0 } 
	{ stateAsWords_q0 sc_in sc_lv 64 signal 0 } 
	{ state_address0 sc_out sc_lv 8 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "stateAsWords_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "stateAsWords", "role": "we0" }} , 
 	{ "name": "stateAsWords_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "stateAsWords", "role": "d0" }} , 
...
set Spec2ImplPortList { 
	stateAsWords { ap_memory {  { stateAsWords_address0 mem_address 1 5 }  { stateAsWords_ce0 mem_ce 1 1 }  { stateAsWords_we0 mem_we 1 1 }  { stateAsWords_d0 mem_din 1 64 }  { stateAsWords_q0 mem_dout 0 64 } } }
