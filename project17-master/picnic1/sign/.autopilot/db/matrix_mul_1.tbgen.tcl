...
set C_modelArgList {
	{ output_r int 32 regular {array 36 { 2 3 } 1 1 }  }
	{ state_offset int 6 regular  }
	{ matrix_offset int 14 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "output_r", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	{ "Name" : "state_offset", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ state_offset sc_in sc_lv 6 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "state_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "state_offset", "role": "default" }} , 
...
set Spec2ImplPortList { 
	output_r { ap_memory {  { output_r_address0 mem_address 1 6 }  { output_r_ce0 mem_ce 1 1 }  { output_r_we0 mem_we 1 4 }  { output_r_d0 mem_din 1 32 }  { output_r_q0 mem_dout 0 32 } } }
	state_offset { ap_none {  { state_offset in_data 0 6 } } }
