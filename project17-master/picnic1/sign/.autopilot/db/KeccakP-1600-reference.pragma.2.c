...
# 147 "sha3/KeccakP-1600-reference.c"
...
{
_ssdm_op_SpecResourceLimit(0, "", "", "1", "");
# 236 "sha3/KeccakP-1600-reference.c"
...
# 271 "sha3/KeccakP-1600-reference.c"
...
_ssdm_op_SpecPipeline(-1, 1, 1, 0, "");
# 281 "sha3/KeccakP-1600-reference.c"
...
{
_ssdm_op_SpecResourceLimit(0, "", "", "1", "");
# 298 "sha3/KeccakP-1600-reference.c"
...
_ssdm_op_SpecPipeline(-1, 1, 1, 0, "");
# 336 "sha3/KeccakP-1600-reference.c"

        C[x] = 0;
        theta_label15:for(y=0; y<5; y++)
_ssdm_Unroll(1, 0, 5, "");
# 338 "sha3/KeccakP-1600-reference.c"
...
_ssdm_op_SpecPipeline(-1, 1, 1, 0, "");
# 344 "sha3/KeccakP-1600-reference.c"
...
_ssdm_op_SpecPipeline(-1, 1, 1, 0, "");
# 352 "sha3/KeccakP-1600-reference.c"
...
static void pi(tKeccakLane *A)
{
    ...
    pi_label20:for(x=0; x<5; x++)
_ssdm_op_SpecPipeline(-1, 1, 1, 0, "");
# 361 "sha3/KeccakP-1600-reference.c"
 pi_label19:for(y=0; y<5; y++)
_ssdm_Unroll(1, 0, 2, "");
# 361 "sha3/KeccakP-1600-reference.c"

        tempA[(((x)%5)+5*((y)%5))] = A[(((x)%5)+5*((y)%5))];
    pi_label22:for(x=0; x<5; x++)
_ssdm_op_SpecPipeline(-1, 1, 1, 0, "");
# 363 "sha3/KeccakP-1600-reference.c"
 pi_label21:for(y=0; y<5; y++)
_ssdm_Unroll(1, 0, 2, "");
# 363 "sha3/KeccakP-1600-reference.c"
...
void KeccakP1600_DisplayRhoOffsets(FILE *f)
{
    ...
    KeccakP1600_DisplayRhoOffsets_label24:for(y=0; y<5; y++)
_ssdm_op_SpecPipeline(-1, 1, 1, 0, "");
# 428 "sha3/KeccakP-1600-reference.c"
 KeccakP1600_DisplayRhoOffsets_label23:for(x=0; x<5; x++) {
_ssdm_Unroll(1, 0, 2, "");
# 428 "sha3/KeccakP-1600-reference.c"
