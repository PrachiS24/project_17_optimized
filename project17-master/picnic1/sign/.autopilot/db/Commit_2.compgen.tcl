...
set out_width 17
set exp i0*i1
set arg_lists {i0 {12 1 +} i1 {8 0 +} p {17 1 +} acc {0} }
set TrueReset 0
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { view_inputShare_address0 { O 12 vector } view_inputShare_ce0 { O 1 bit } view_inputShare_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { view_communicatedBits_address0 { O 16 vector } view_communicatedBits_ce0 { O 1 bit } view_communicatedBits_q0 { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { view_outputShare_address0 { O 12 vector } view_outputShare_ce0 { O 1 bit } view_outputShare_q0 { I 32 vector } } \
} "
} else {
