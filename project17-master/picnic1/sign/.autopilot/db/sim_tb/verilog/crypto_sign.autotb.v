...
`define AUTOTB_TVIN_viewOutputs  "./c.crypto_sign.autotvin_viewOutputs.dat"
...
`define AUTOTB_TVIN_viewOutputs_out_wrapc  "./rtl.crypto_sign.autotvin_viewOutputs.dat"
`define AUTOTB_TVOUT_sm  "./c.crypto_sign.autotvout_sm.dat"
`define AUTOTB_TVOUT_smlen  "./c.crypto_sign.autotvout_smlen.dat"
`define AUTOTB_TVOUT_viewOutputs  "./c.crypto_sign.autotvout_viewOutputs.dat"
...
`define AUTOTB_TVOUT_viewOutputs_out_wrapc  "./impl_rtl.crypto_sign.autotvout_viewOutputs.dat"
...
wire [13 : 0] viewOutputs_address1;
wire  viewOutputs_ce1;
wire [31 : 0] viewOutputs_q1;
wire [31 : 0] ap_return;
integer done_cnt = 0;
...
`AUTOTB_DUT `AUTOTB_DUT_INST(
    ...
    .viewOutputs_address1(viewOutputs_address1),
    .viewOutputs_ce1(viewOutputs_ce1),
...
assign arraysm_ready= ready_initial | arraysm_done;
assign arraysm_done =    AESL_done_delay;
...
assign arrayviewOutputs_address1 = viewOutputs_address1;
assign arrayviewOutputs_ce1 = viewOutputs_ce1;
assign viewOutputs_q1 = arrayviewOutputs_dout1;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.crypto_sign.autotvout_viewOutputs.dat", "r");
    fp2 = $fopen("./impl_rtl.crypto_sign.autotvout_viewOutputs.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.crypto_sign.autotvout_viewOutputs.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.crypto_sign.autotvout_viewOutputs.dat\"!");
    else begin
        $display("Comparing rtl.crypto_sign.autotvout_viewOutputs.dat with impl_rtl.crypto_sign.autotvout_viewOutputs.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
