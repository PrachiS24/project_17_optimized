# 1 "C:/Users/vlsigroup/Downloads/project17-master_3/project17-master/sha3/KeccakP-1600-reference.c"
# 1 "C:/Users/vlsigroup/Downloads/project17-master_3/project17-master/sha3/KeccakP-1600-reference.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Users/vlsigroup/Downloads/project17-master_3/project17-master/sha3/KeccakP-1600-reference.c" 2
# 16 "C:/Users/vlsigroup/Downloads/project17-master_3/project17-master/sha3/KeccakP-1600-reference.c"
...
# 17 "C:/Users/vlsigroup/Downloads/project17-master_3/project17-master/sha3/KeccakP-1600-reference.c" 2
...
# 18 "C:/Users/vlsigroup/Downloads/project17-master_3/project17-master/sha3/KeccakP-1600-reference.c" 2
...
# 19 "C:/Users/vlsigroup/Downloads/project17-master_3/project17-master/sha3/KeccakP-1600-reference.c" 2
...
# 20 "C:/Users/vlsigroup/Downloads/project17-master_3/project17-master/sha3/KeccakP-1600-reference.c" 2
# 1 "C:/Users/vlsigroup/Downloads/project17-master_3/project17-master/sha3/brg_endian.h" 1
# 21 "C:/Users/vlsigroup/Downloads/project17-master_3/project17-master/sha3/KeccakP-1600-reference.c" 2
...
# 98 "C:/Users/vlsigroup/Downloads/project17-master_3/project17-master/sha3/KeccakP-1600-reference.c"
...
{
    (void) ((!!(offset < 200)) || (_assert("offset < 200","C:/Users/vlsigroup/Downloads/project17-master_3/project17-master/sha3/KeccakP-1600-reference.c",148),0));
    state[offset] ^= byte;
}
...
{
    (void) ((!!(offset < 200)) || (_assert("offset < 200","C:/Users/vlsigroup/Downloads/project17-master_3/project17-master/sha3/KeccakP-1600-reference.c",168),0));
    (void) ((!!(offset+length <= 200)) || (_assert("offset+length <= 200","C:/Users/vlsigroup/Downloads/project17-master_3/project17-master/sha3/KeccakP-1600-reference.c",169),0));
...
{
    (void) ((!!(byteCount <= 200)) || (_assert("byteCount <= 200","C:/Users/vlsigroup/Downloads/project17-master_3/project17-master/sha3/KeccakP-1600-reference.c",177),0));
...
{
# 203 "C:/Users/vlsigroup/Downloads/project17-master_3/project17-master/sha3/KeccakP-1600-reference.c"
    KeccakP1600OnWords((tKeccakLane*)state, nrounds);
# 212 "C:/Users/vlsigroup/Downloads/project17-master_3/project17-master/sha3/KeccakP-1600-reference.c"
}

void KeccakP1600_Permute_12rounds(unsigned char *state)
{
# 224 "C:/Users/vlsigroup/Downloads/project17-master_3/project17-master/sha3/KeccakP-1600-reference.c"
    KeccakP1600OnWords((tKeccakLane*)state, 12);
# 233 "C:/Users/vlsigroup/Downloads/project17-master_3/project17-master/sha3/KeccakP-1600-reference.c"
}
...
# 256 "C:/Users/vlsigroup/Downloads/project17-master_3/project17-master/sha3/KeccakP-1600-reference.c"
...
static void fromBytesToWords(tKeccakLane *stateAsWords, const unsigned char *state)
{
    ...
    for(i=0; i<25; i++) {
        stateAsWords[i] = 0;
        fromBytesToWords_label13:for(j=0; j<(64/8); j++)
...
static void fromWordsToBytes(unsigned char *state, const tKeccakLane *stateAsWords)
{
    ...
    for(i=0; i<25; i++)
        fromWordsToBytes_label14:for(j=0; j<(64/8); j++)
...
static void theta(tKeccakLane *A)
{
    ...
    theta_label16:for(x=0; x<5; x++) {
        C[x] = 0;
        theta_label15:for(y=0; y<5; y++)
            C[x] ^= A[(((x)%5)+5*((y)%5))];
    }
    for(x=0; x<5; x++)
        D[x] = ((1 != 0) ? ((((tKeccakLane)C[(x+1)%5]) << 1) ^ (((tKeccakLane)C[(x+1)%5]) >> (64 -1))) : C[(x+1)%5]) ^ C[(x+4)%5];
    for(x=0; x<5; x++)
        theta_label17:for(y=0; y<5; y++)
            A[(((x)%5)+5*((y)%5))] ^= D[x];
}
...
static void rho(tKeccakLane *A)
{
    ...
    for(x=0; x<5; x++) rho_label18:for(y=0; y<5; y++)
...
static void pi(tKeccakLane *A)
{
    ...
    pi_label20:for(x=0; x<5; x++) pi_label19:for(y=0; y<5; y++)
        tempA[(((x)%5)+5*((y)%5))] = A[(((x)%5)+5*((y)%5))];
    pi_label22:for(x=0; x<5; x++) pi_label21:for(y=0; y<5; y++)
...
{
    (void) ((!!(offset < 200)) || (_assert("offset < 200","C:/Users/vlsigroup/Downloads/project17-master_3/project17-master/sha3/KeccakP-1600-reference.c",389),0));
    (void) ((!!(offset+length <= 200)) || (_assert("offset+length <= 200","C:/Users/vlsigroup/Downloads/project17-master_3/project17-master/sha3/KeccakP-1600-reference.c",390),0));
...
void KeccakP1600_ExtractAndAddBytes(const unsigned char *state, const unsigned char *input, unsigned char *output, unsigned int offset, unsigned int length)
{
    ...
    (void) ((!!(offset < 200)) || (_assert("offset < 200","C:/Users/vlsigroup/Downloads/project17-master_3/project17-master/sha3/KeccakP-1600-reference.c",403),0));
    (void) ((!!(offset+length <= 200)) || (_assert("offset+length <= 200","C:/Users/vlsigroup/Downloads/project17-master_3/project17-master/sha3/KeccakP-1600-reference.c",404),0));
    for(i=0; i<length; i++)
...
void KeccakP1600_DisplayRhoOffsets(FILE *f)
{
    ...
    KeccakP1600_DisplayRhoOffsets_label24:for(y=0; y<5; y++) KeccakP1600_DisplayRhoOffsets_label23:for(x=0; x<5; x++) {
