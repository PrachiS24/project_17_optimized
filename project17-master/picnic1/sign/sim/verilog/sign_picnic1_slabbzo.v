...
// ==============================================================
`timescale 1 ns / 1 ps
module sign_picnic1_slabbzo_ram (addr0, ce0, d0, we0, q0, addr1, ce1, d1, we1, q1,  clk);
...
sign_picnic1_slabbzo_ram sign_picnic1_slabbzo_ram_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .we0( we0 ),
